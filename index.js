...
const zooAnimals = [
 ...
 function animalNames(){
  ...
  zooAnimals.forEach(function(item,index,array){
      names.push("name: " + array[index].animal_name + ", scientific: " + array[index].scientific_name);
 ...
 function lowerCaseNames(array){
  let lowerCasedArray= array.map(lowFunction)
  function lowFunction (array){
  ...
  */
  ...
  function lowPopulationAnimals(array){
    return array.filter((lowPop)=>lowPop.population < 5);
  }
  ...
  */
  ...
  function USApop(array){
    let pop = array.reduce((acc,val)=>acc+val["population"],0);
    return pop
  }
